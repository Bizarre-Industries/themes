...
call s:H('Normal', '#E4E4E4', '#000000', '')
call s:H('NormalNC', '#E4E4E4', '#000000', '')
call s:H('CursorLine', '', '#0E0E0E', '')
call s:H('CursorLineNr', '#C6FF24', '#000000', 'bold')
call s:H('LineNr', '#545454', '#000000', '')
call s:H('SignColumn', '', '#000000', '')
call s:H('Visual', '', '#3A4D0E', '')
...
call s:H('StatusLineNC', '#7A7A7A', '#0E0E0E', '')
call s:H('TabLine', '#7A7A7A', '#0E0E0E', '')
call s:H('TabLineFill', '', '#0E0E0E', '')
call s:H('TabLineSel', '#0E0E0E', '#C6FF24', 'bold')
call s:H('VertSplit', '#545454', '#000000', '')
call s:H('Folded', '#7A7A7A', '#0E0E0E', '')
call s:H('FoldColumn', '#545454', '#000000', '')
...
call s:H('DiffAdd', '#5BD06B', '#000000', '')
call s:H('DiffChange', '#FFB85C', '#000000', '')
call s:H('DiffDelete', '#FF6F77', '#000000', '')
