...
call s:H('Normal', '#1A1A1A', '#F5F2EA', '')
call s:H('NormalNC', '#1A1A1A', '#F5F2EA', '')
call s:H('CursorLine', '', '#EDE9DD', '')
call s:H('CursorLineNr', '#5F8A0F', '#F5F2EA', 'bold')
call s:H('LineNr', '#B0AA9A', '#F5F2EA', '')
call s:H('SignColumn', '', '#F5F2EA', '')
call s:H('Visual', '', '#D4E89F', '')
call s:H('Search', '#F9F8F2', '#5F8A0F', '')
call s:H('IncSearch', '#0E0E0E', '#9FCC1F', 'bold')
call s:H('CurSearch', '#0E0E0E', '#9FCC1F', 'bold')
call s:H('MatchParen', '#5F8A0F', '', 'bold,underline')
call s:H('Pmenu', '#2B2B2B', '#EDE9DD', '')
call s:H('PmenuSel', '#F9F8F2', '#5F8A0F', 'bold')
call s:H('PmenuSbar', '', '#DDD8CB', '')
call s:H('PmenuThumb', '', '#B0AA9A', '')
call s:H('StatusLine', '#2B2B2B', '#EDE9DD', '')
call s:H('StatusLineNC', '#857F70', '#EDE9DD', '')
call s:H('TabLine', '#857F70', '#EDE9DD', '')
call s:H('TabLineFill', '', '#EDE9DD', '')
call s:H('TabLineSel', '#F9F8F2', '#5F8A0F', 'bold')
call s:H('VertSplit', '#DDD8CB', '#F5F2EA', '')
call s:H('Folded', '#857F70', '#EDE9DD', '')
call s:H('FoldColumn', '#B0AA9A', '#F5F2EA', '')
call s:H('SpecialKey', '#DDD8CB', '', '')
call s:H('NonText', '#DDD8CB', '', '')
call s:H('Whitespace', '#DDD8CB', '', '')
...
call s:H('MoreMsg', '#3F7A1F', '', '')
call s:H('WildMenu', '#F9F8F2', '#5F8A0F', '')
call s:H('Cursor', '#F9F8F2', '#5F8A0F', '')
call s:H('lCursor', '#F9F8F2', '#5F8A0F', '')
...
call s:H('SpecialChar', '#A85C1B', '', '')
call s:H('Tag', '#B8276F', '', '')
call s:H('Delimiter', '#8A8576', '', '')
call s:H('Underlined', '#1F4FB0', '', 'underline')
call s:H('Error', '#B8276F', '', 'bold')
call s:H('Todo', '#F9F8F2', '#5F8A0F', 'bold')
call s:H('DiffAdd', '#3F7A1F', '#F5F2EA', '')
call s:H('DiffChange', '#9F4A0E', '#F5F2EA', '')
call s:H('DiffDelete', '#B8276F', '#F5F2EA', '')
call s:H('DiffText', '#2B2B2B', '#EDE9DD', 'bold')
