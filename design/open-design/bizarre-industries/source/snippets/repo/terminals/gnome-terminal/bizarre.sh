...
case "$variant" in
  ...
  bizarre-paper)
    ...
    selection_bg="#DCEFA8"
    selection_fg="#0E0E0E"
    palette="#1A1A1A:#C13039:#3F7A1F:#9F4A0E:#1F4FB0:#7E2A9A:#0F6E6E:#545454:#726D61:#C63947:#4A7409:#94631C:#386EB6:#95559F:#397777:#0E0E0E"
    ;;
  bizarre-bone)
    name="Bizarre Bone"
    bg="#F5F2EA"
    ...
    selection_bg="#D4E89F"
    selection_fg="#0E0E0E"
    palette="#2B2B2B:#C13039:#3F7A1F:#9F4A0E:#1F4FB0:#7E2A9A:#0F6E6E:#545454:#726D61:#C63947:#4A7409:#94631C:#386EB6:#95559F:#397777:#0E0E0E"
    ;;
  *)
