...
// from this file by scripts/generate.cjs. Edit here, never edit configs.
//
// Layout:
...
const brand = {
  ...
  limeInk:     '#5F8A0F',  // graphic / fill accent on light
  limeText:    '#4A7409',  // accessible text accent on light
...
const ansiLight = {
  ...
  brBlack:   '#726D61',
  brRed:     '#C63947',
  brGreen:   brand.limeText, // Lime Text
  brYellow:  '#94631C',
  brBlue:    '#386EB6',
  brMagenta: '#95559F',
  brCyan:    '#397777',
