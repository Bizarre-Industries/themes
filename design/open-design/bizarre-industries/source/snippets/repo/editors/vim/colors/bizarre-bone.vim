...
call s:H('CursorLineNr', '#4A7409', '#F5F2EA', 'bold')
call s:H('LineNr', '#4A4A4A', '#F5F2EA', '')
...
call s:H('DiffAdd', '#36691B', '#F5F2EA', '')
call s:H('DiffChange', '#97460D', '#F5F2EA', '')
call s:H('DiffDelete', '#AC2468', '#F5F2EA', '')
